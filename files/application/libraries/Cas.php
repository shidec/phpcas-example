...
class Cas {
    ...
    public function cas_login() {
        ...
        $session_data = array(
			...
			'kode_prodi' => $this->CASUSER->local_account->kode_prodi,
            'id_jurusan' => $this->CASUSER->local_account->id_jurusan,
            'id_fakultas' => $this->CASUSER->local_account->id_fakultas,
